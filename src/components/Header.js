  ...
  return (
    <header className="bg-indigo-950 shadow-lg sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center py-3">
        ...
        {/* Navigation Links */}
        <nav
          className={`${isOpen ? 'max-h-screen' : 'max-h-0'} lg:max-h-full overflow-hidden lg:overflow-visible lg:flex lg:flex-row lg:space-x-6 text-base font-small w-full lg:w-auto absolute lg:static top-full left-0 bg-indigo-950 lg:bg-transparent z-40 lg:z-auto px-6 lg:px-0 transition-all duration-300 ease-in-out`}
        >
