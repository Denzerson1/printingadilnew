...
import backgroundImage from '../../images/flatsilicone.jpg'; // Replace with the path to your background image
import ScrollToTop from '../../components/ScrollToTop';

import img1 from '../../images/silicone-flat/1.jpg';
import img2 from '../../images/silicone-flat/2.jpg';
import img3 from '../../images/silicone-flat/3.jpg';
import img4 from '../../images/silicone-flat/4.jpg';
import img5 from '../../images/silicone-flat/5.jpg';
                    ...
                    <nav className="bg-gray-100 py-3 sm:py-4">
                        <div className="container mx-auto px-4">
                            <ol className="flex flex-wrap text-gray-500 text-xs sm:text-sm">
                                ...
                                <li className="mx-2">/</li>
                                <li className="text-gray-800">FLAT</li>
                            </ol>
                        </div>
                    </nav>
                    ...
                    <div className="max-w-5xl mx-auto p-4 md:p-6">
                        <div className="flex flex-col md:flex-row items-start md:space-x-8">
                            ...
                            <div className="flex-1">
                                <h1 className="text-2xl font-semibold text-gray-900 mb-3">FLAT SILICONE TRANSFER</h1>
                                <p className="text-sm text-gray-700 mb-2">
                                    Our Flat Silicone Transfer provides a sleek and smooth finish, perfect for detailed designs and intricate graphics.
                                </p>
                                <p className="text-sm text-gray-700 mb-3">
                                    Advantages of Flat Silicone Transfers include:
                                </p>

                                <h2 className="text-lg font-medium text-gray-800 mb-3">The multiple advantages of Flat Silicone transfers are:</h2>
                                <ul className="list-disc list-inside text-sm text-gray-700 space-y-1 mb-3">
                                    <li>Flat, smooth finish that adheres well to fabrics</li>
                                    <li>Durable and able to withstand repeated washing</li>
                                    <li>Great for subtle designs and logos</li>
                                </ul>

                                <p className="text-sm text-gray-700 mb-2">
                                    <strong>+ Lightweight option:</strong> Does not add bulk, maintaining the garment's original feel.
                                </p>
                                <p className="text-sm text-gray-700 mb-5">
                                    <strong>+ Versatile use:</strong> Suitable for a variety of fabrics, including cotton and polyester.
                                </p>
