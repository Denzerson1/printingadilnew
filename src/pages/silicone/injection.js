...
import backgroundImage from '../../images/siliconemolding.jpg'; // Replace with the path to your background image
import ScrollToTop from '../../components/ScrollToTop';

import img1 from '../../images/silicone-injectionmolding/1.jpg';
import img2 from '../../images/silicone-injectionmolding/2.jpg';
import img3 from '../../images/silicone-injectionmolding/3.jpg';
                    ...
                    <nav className="bg-gray-100 py-3 sm:py-4">
                        <div className="container mx-auto px-4">
                            <ol className="flex flex-wrap text-gray-500 text-xs sm:text-sm">
                                ...
                                <li className="mx-2">/</li>
                                <li className="text-gray-800">INJECTION MOLDING</li>
                            </ol>
                        </div>
                    </nav>
                    ...
                    <div className="max-w-5xl mx-auto p-4 md:p-6">
                        <div className="flex flex-col md:flex-row items-start md:space-x-8">
                            ...
                            <div className="flex-1">
                                <h1 className="text-2xl font-semibold text-gray-900 mb-3">SILICONE INJECTION MOLDING</h1>
                                <p className="text-sm text-gray-700 mb-2">
                                    Our Silicone Injection Molding offers unparalleled precision and quality, ideal for creating unique, custom shapes and designs.
                                </p>
                                <p className="text-sm text-gray-700 mb-3">
                                    Advantages of Silicone Injection Molding include:
                                </p>

                                <h2 className="text-lg font-medium text-gray-800 mb-3">The multiple advantages of Silicone Injection Molding are:</h2>
                                <ul className="list-disc list-inside text-sm text-gray-700 space-y-1 mb-3">
                                    <li>High precision for intricate designs and logos</li>
                                    <li>Exceptional durability and weather resistance</li>
                                    <li>Great for creating custom shapes and sizes</li>
                                </ul>

                                <p className="text-sm text-gray-700 mb-2">
                                    <strong>+ Custom color options:</strong> Available in a wide range of colors to match your branding.
                                </p>
                                <p className="text-sm text-gray-700 mb-5">
                                    <strong>+ Fast production time:</strong> Efficient manufacturing process ensures quick turnaround on orders.
                                </p>
