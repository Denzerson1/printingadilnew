...
import backgroundImage from '../../images/showcase3.jpg'; // Replace with the path to your background image
import ScrollToTop from '../../components/ScrollToTop';

import img1 from '../../images/silicone-patch/1.jpeg';
import img2 from '../../images/silicone-patch/2.jpeg';
import img3 from '../../images/silicone-patch/3.jpeg';
import img4 from '../../images/silicone-patch/4.jpeg';
import img5 from '../../images/silicone-patch/5.jpeg';
import img6 from '../../images/silicone-patch/6.jpeg';
import img7 from '../../images/silicone-patch/7.jpeg';
import img8 from '../../images/silicone-patch/8.jpeg';
                    ...
                    <nav className="bg-gray-100 py-3 sm:py-4">
                        <div className="container mx-auto px-4">
                            <ol className="flex flex-wrap text-gray-500 text-xs sm:text-sm">
                                ...
                                <li className="mx-2">/</li>
                                <li className="text-gray-800">3D PATCH LOGO</li>
                            </ol>
                        </div>
                    </nav>
                    ...
                    <div className="max-w-5xl mx-auto p-4 md:p-6">
                        <div className="flex flex-col md:flex-row items-start md:space-x-8">
                            ...
                            <div className="flex-1">
                                <h1 className="text-2xl font-semibold text-gray-900 mb-3">3D SILICONE PATCH LOGO</h1>
                                <p className="text-sm text-gray-700 mb-2">
                                    Make your brand stand out with our 3D Silicone Patch Logo, designed for a vibrant and textured look that captures attention.
                                </p>
                                <p className="text-sm text-gray-700 mb-3">
                                    Advantages of 3D Silicone Patch Logos include:
                                </p>

                                <h2 className="text-lg font-medium text-gray-800 mb-3">The multiple advantages of 3D Silicone Patch logos are:</h2>
                                <ul className="list-disc list-inside text-sm text-gray-700 space-y-1 mb-3">
                                    <li>Textured finish that adds depth to your branding</li>
                                    <li>Long-lasting and resistant to fading</li>
                                    <li>Ideal for jackets, bags, and promotional items</li>
                                </ul>

                                <p className="text-sm text-gray-700 mb-2">
                                    <strong>+ Custom shapes available:</strong> Tailored to your specific design for a unique look.
                                </p>
                                <p className="text-sm text-gray-700 mb-5">
                                    <strong>+ Quick application:</strong> Designed for easy and efficient transfer onto various fabrics.
                                </p>
