...
import backgroundImage from '../../images/laserreflective.jpeg'; // Replace with the path to your background image
                ...
                <div className="max-w-5xl mx-auto p-4 md:p-6">
                    <div className="flex flex-col md:flex-row items-start md:space-x-8">
                        ...
                        <div className="flex-1">
                            <h1 className="text-2xl font-semibold text-gray-900 mb-3">REFLECTIVE LASERCUT TRANSFER</h1>

                            <p className="text-sm text-gray-700 mb-2">
                                Ensure visibility with our Reflective Laser Cut Transfer, perfect for safety gear, sportswear, or outdoor apparel.
                            </p>
                            <p className="text-sm text-gray-700 mb-3">
                                Advantages of Reflective Laser Cut Transfers include:
                            </p>

                            <h2 className="text-lg font-medium text-gray-800 mb-3">The multiple advantages of Reflective Laser Cut transfers are:</h2>
                            <ul className="list-disc list-inside text-sm text-gray-700 space-y-1 mb-3">
                                <li>High visibility in low-light conditions</li>
                                <li>Washable and durable for outdoor use</li>
                                <li>Easy to apply with pre-cut designs</li>
                            </ul>

                            <p className="text-sm text-gray-700 mb-2">
                                <strong>+ UV-resistant option:</strong> Developed to ensure that the reflective effect remains strong even after exposure to sunlight.
                            </p>
                            <p className="text-sm text-gray-700 mb-5">
                                <strong>+ Waterproof option:</strong> Ideal for outdoor applications and wet conditions.
                            </p>
