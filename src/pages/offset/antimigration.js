...
import backgroundImage from '../../images/offsetantimigration.jpg'; // Replace with the path to your background image
                ...
                <nav className="bg-gray-100 py-3 sm:py-4">
                    <div className="container mx-auto px-4">
                        <ol className="flex flex-wrap text-gray-500 text-xs sm:text-sm">
                            ...
                            <li className="mx-2">/</li>
                            <li className="text-gray-800">ANTI MIGRATION</li>
                        </ol>
                    </div>
                </nav>
                ...
                <div className="max-w-5xl mx-auto p-4 md:p-6">
                    <div className="flex flex-col md:flex-row items-start md:space-x-8">
                        ...
                        <div className="flex-1">
                            <h1 className="text-2xl font-semibold text-gray-900 mb-3">ANTI MIGRATION TRANSFER</h1>

                            <p className="text-sm text-gray-700 mb-2">
                                Prevent color migration with our Offset Anti-Migration Transfer, ideal for designs on synthetic fabrics.
                            </p>
                            <p className="text-sm text-gray-700 mb-3">
                                Advantages of Offset Anti-Migration Transfers include:
                            </p>

                            <h2 className="text-lg font-medium text-gray-800 mb-3">The multiple advantages of Offset Anti-Migration transfers are:</h2>
                            <ul className="list-disc list-inside text-sm text-gray-700 space-y-1 mb-3">
                                <li>Prevents dye migration on polyester fabrics</li>
                                <li>Excellent durability and washability</li>
                                <li>High print clarity and color accuracy</li>
                            </ul>

                            <p className="text-sm text-gray-700 mb-2">
                                <strong>+ Eco-solvent ink option:</strong> Ensures better environmental performance and lower emissions during production.
                            </p>
                            <p className="text-sm text-gray-700 mb-5">
                                <strong>+ UV-protection option:</strong> Prevents colors from fading when exposed to sunlight for extended periods.
                            </p>
