...
import backgroundImage from '../../images/offsetreflective.jpeg';
import ScrollToTop from '../../components/ScrollToTop';

import img1 from '../../images/offset-reflective/1.jpg';
import img2 from '../../images/offset-reflective/2.jpg';
import img3 from '../../images/offset-reflective/3.jpg';
import img4 from '../../images/offset-reflective/4.jpeg';
                ...
                <div className="max-w-5xl mx-auto p-4 md:p-6">
                    <div className="flex flex-col md:flex-row items-start md:space-x-8">
                        ...
                        <div className="flex-1">
                            <h1 className="text-2xl font-semibold text-gray-900 mb-3">REFLECTIVE OFFSET TRANSFER</h1>

                            <p className="text-sm text-gray-700 mb-2">
                                Achieve high visibility and sharp designs with our Offset Reflective Transfer, perfect for safety and outdoor garments.
                            </p>
                            <p className="text-sm text-gray-700 mb-3">
                                Advantages of Offset Reflective Transfers include:
                            </p>

                            <h2 className="text-lg font-medium text-gray-800 mb-3">The multiple advantages of Offset Reflective transfers are:</h2>
                            <ul className="list-disc list-inside text-sm text-gray-700 space-y-1 mb-3">
                                <li>Reflective properties for visibility in low light</li>
                                <li>Sharp and detailed designs</li>
                                <li>Durable and washable</li>
                            </ul>

                            <p className="text-sm text-gray-700 mb-2">
                                <strong>+ Scratch-resistant option:</strong> Ensures the reflective surface stays smooth and free of damage.
                            </p>
                            <p className="text-sm text-gray-700 mb-5">
                                <strong>+ High-flexibility option:</strong> Makes the transfer suitable for stretchable fabrics without cracking or distorting.
                            </p>
