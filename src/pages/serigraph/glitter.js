...
import backgroundImage from '../../images/glitter.jpg'; // Replace with the path to your background image
import ScrollToTop from '../../components/ScrollToTop';

import img1 from '../../images/serigraph-glitter/1.jpg';
import img2 from '../../images/serigraph-glitter/2.jpg';
import img3 from '../../images/serigraph-glitter/3.jpg';
import img4 from '../../images/serigraph-glitter/4.webp';
import img5 from '../../images/serigraph-glitter/5.jpg';
                    ...
                    <div className="max-w-5xl mx-auto p-4 md:p-6">
                        <div className="flex flex-col md:flex-row items-start md:space-x-8">
                            ...
                            <div className="flex-1">
                                <h1 className="text-2xl font-semibold text-gray-900 mb-3">GLITTER SERIGRAPH TRANSFER</h1>
                                <p className="text-sm text-gray-700 mb-2">
                                    Sparkle and shine with our Glitter Serigraph Transfer, ideal for adding a festive touch to any design.
                                </p>
                                <p className="text-sm text-gray-700 mb-3">
                                    Advantages of Glitter Serigraph Transfers include:
                                </p>

                                <h2 className="text-lg font-medium text-gray-800 mb-3">The multiple advantages of Glitter transfers are:</h2>
                                <ul className="list-disc list-inside text-sm text-gray-700 space-y-1 mb-3">
                                    <li>Vibrant glitter finish for eye-catching designs</li>
                                    <li>Durable and washable without losing sparkle</li>
                                    <li>Perfect for fashion, parties, or special occasions</li>
                                </ul>

                                <p className="text-sm text-gray-700 mb-2">
                                    <strong>+ Non-shedding option:</strong> Ensures that glitter stays intact and doesn't fall off over time.
                                </p>
                                <p className="text-sm text-gray-700 mb-5">
                                    <strong>+ Eco-friendly option:</strong> Made from sustainable materials, offering a responsible choice for your designs.
                                </p>
