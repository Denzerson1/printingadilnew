...
import backgroundImage from '../../images/flock.jpg'; // Replace with the path to your background image
import ScrollToTop from '../../components/ScrollToTop';

import img1 from '../../images/serigraph-flock/1.jpg';
import img2 from '../../images/serigraph-flock/2.jpg';
import img3 from '../../images/serigraph-flock/3.jpg';
import img4 from '../../images/serigraph-flock/4.jpeg';
import img5 from '../../images/serigraph-flock/5.jpeg';
import img6 from '../../images/serigraph-flock/6.jpeg';
                    ...
                    <nav className="bg-gray-100 py-3 sm:py-4">
                        <div className="container mx-auto px-4">
                            <ol className="flex flex-wrap text-gray-500 text-xs sm:text-sm">
                                ...
                                <li className="mx-2">/</li>
                                <li className="text-gray-800">FLOCK MULTICOLOR</li>
                            </ol>
                        </div>
                    </nav>
                    ...
                    <div className="max-w-5xl mx-auto p-4 md:p-6">
                        <div className="flex flex-col md:flex-row items-start md:space-x-8">
                            ...
                            <div className="flex-1">
                                <h1 className="text-2xl font-semibold text-gray-900 mb-3">FLOCK MULTICOLOR SERIGRAPH TRANSFER</h1>
                                <p className="text-sm text-gray-700 mb-2">
                                    Add a soft touch with our Flock Multicolor Serigraph Transfer, perfect for creating luxurious textures in your designs.
                                </p>
                                <p className="text-sm text-gray-700 mb-3">
                                    Advantages of Flock Multicolor Serigraph Transfers include:
                                </p>

                                <h2 className="text-lg font-medium text-gray-800 mb-3">The multiple advantages of Flock Multicolor transfers are:</h2>
                                <ul className="list-disc list-inside text-sm text-gray-700 space-y-1 mb-3">
                                    <li>Soft, velvety texture for a premium feel</li>
                                    <li>Available in multiple colors for creative designs</li>
                                    <li>Durable and can withstand repeated washing</li>
                                </ul>

                                <p className="text-sm text-gray-700 mb-2">
                                    <strong>+ Colorfast option:</strong> Ensures colors stay vibrant and do not fade after multiple washes.
                                </p>
                                <p className="text-sm text-gray-700 mb-5">
                                    <strong>+ Lightweight option:</strong> Keeps the garment feeling comfortable while providing an eye-catching texture.
                                </p>
