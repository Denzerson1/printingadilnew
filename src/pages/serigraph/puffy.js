                    ...
                    <nav className="bg-gray-100 py-3 sm:py-4">
                        <div className="container mx-auto px-4">
                            <ol className="flex flex-wrap text-gray-500 text-xs sm:text-sm">
                                ...
                                <li className="mx-2">/</li>
                                <li className="text-gray-800">PUFFY</li>
                            </ol>
                        </div>
                    </nav>
                    ...
                    <div className="max-w-5xl mx-auto p-4 md:p-6">
                        <div className="flex flex-col md:flex-row items-start md:space-x-8">
                            ...
                            <div className="flex-1">
                                <h1 className="text-2xl font-semibold text-gray-900 mb-3">PUFFY SERIGRAPH TRANSFER</h1>
                                <p className="text-sm text-gray-700 mb-2">
                                    Add dimension and texture with our Puffy Serigraph Transfer, perfect for creative designs that stand out.
                                </p>
                                <p className="text-sm text-gray-700 mb-3">
                                    Advantages of Puffy Serigraph Transfers include:
                                </p>

                                <h2 className="text-lg font-medium text-gray-800 mb-3">The multiple advantages of Puffy transfers are:</h2>
                                <ul className="list-disc list-inside text-sm text-gray-700 space-y-1 mb-3">
                                    <li>Raised texture that adds visual interest</li>
                                    <li>Great for playful or bold designs</li>
                                    <li>Durable and can withstand multiple washes</li>
                                </ul>

                                <p className="text-sm text-gray-700 mb-2">
                                    <strong>+ Flexible puff option:</strong> Ensures the raised design maintains its shape and flexibility during wear.
                                </p>
                                <p className="text-sm text-gray-700 mb-5">
                                    <strong>+ Non-cracking option:</strong> Prevents the design from cracking over time, keeping your garment looking fresh.
                                </p>
