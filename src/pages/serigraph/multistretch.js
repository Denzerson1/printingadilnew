...
import backgroundImage from '../../images/showcase1.jpg'; // Replace with the path to your background image
import ScrollToTop from '../../components/ScrollToTop';

import img1 from '../../images/serigraph-multistretch/1.jpg';
import img2 from '../../images/serigraph-multistretch/2.jpg';
import img3 from '../../images/serigraph-multistretch/3.jpg';
import img4 from '../../images/serigraph-multistretch/4.jpg';
import img5 from '../../images/serigraph-multistretch/5.jpg';
import img6 from '../../images/serigraph-multistretch/6.jpg';
                    ...
                    <nav className="bg-gray-100 py-3 sm:py-4">
                        <div className="container mx-auto px-4">
                            <ol className="flex flex-wrap text-gray-500 text-xs sm:text-sm">
                                ...
                                <li className="mx-2">/</li>
                                <li className="text-gray-800">MULTISTRETCH</li>
                            </ol>
                        </div>
                    </nav>
                    ...
                    <div className="max-w-5xl mx-auto p-4 md:p-6">
                        <div className="flex flex-col md:flex-row items-start md:space-x-8">
                            ...
                            <div className="flex-1">
                                <h1 className="text-2xl font-semibold text-gray-900 mb-3">MULTI-STRETCH SERIGRAPH TRANSFER</h1>
                                <p className="text-sm text-gray-700 mb-2">
                                    Achieve flexibility and comfort with our Multi-Stretch Serigraph Transfer, designed for activewear and fitted apparel.
                                </p>
                                <p className="text-sm text-gray-700 mb-3">
                                    Advantages of Multi-Stretch Serigraph Transfers include:
                                </p>

                                <h2 className="text-lg font-medium text-gray-800 mb-3">The multiple advantages of Multi-Stretch transfers are:</h2>
                                <ul className="list-disc list-inside text-sm text-gray-700 space-y-1 mb-3">
                                    <li>Allows for maximum stretch without cracking</li>
                                    <li>Perfect for performance fabrics and athletic wear</li>
                                    <li>Vibrant colors that stay true after washing</li>
                                </ul>

                                <p className="text-sm text-gray-700 mb-2">
                                    <strong>+ Breathable option:</strong> Ensures comfort and moisture control during physical activities.
                                </p>
                                <p className="text-sm text-gray-700 mb-5">
                                    <strong>+ Lightweight option:</strong> Keeps the garment feeling light and comfortable while maintaining design integrity.
                                </p>
